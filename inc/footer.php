<footer class="mx-auto pt-16">
  <div class="flex flex-col items-center border-t border-b py-6">
    ...
    <nav class="flex flex-wrap justify-center gap-x-4 gap-y-2 text-sm md:justify-start md:gap-6">
      ...
      <a href="/gs_php/php04/kadai/diary/" class="text-gray-300 transition duration-100 hover:text-sky-500 active:text-sky-600">日記を書く</a>
      <a href="/gs_php/php04/kadai/diary/list/" class="text-gray-300 transition duration-100 hover:text-sky-500 active:text-sky-600">みんなの日記</a>
      <a href="/gs_php/php04/kadai/login/logout.php" class="text-gray-300 transition duration-100 hover:text-sky-500 active:text-sky-600">ログアウト</a>
    </nav>
    <!-- nav - end -->
  </div>
  <div class="py-8 text-center text-sm text-gray-300">© 2024 - kadai.</div>
</footer>
