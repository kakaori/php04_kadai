<?php $title = 'GEEK日記登録完了｜LAB17 GEEK日記'; ?>
...
//３．データ登録SQL作成
$sql = "INSERT INTO gs_table(userid,name,q1,q2,q3,q4,q5,q6,indate)VALUES(:userid,:name,:credo,:community,:improvement,:thanks,:message,:cosmos,sysdate())";
...
<div class="mx-auto max-w-screen-md px-4 md:px-8">
    ...
    <h2 class="mb-4 text-center text-2xl font-bold md:mb-8 lg:text-3xl xl:mb-12">登録が完了しました</h2>
